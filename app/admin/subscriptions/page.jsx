'use client'
import SubscriptionItemTable from '@/Components/AdminComponent/SubscriptionItemTable'
                ...
                <table className="w-full text-sm text-gray-500">
                    ...
                    <tbody>
                        {emails.map((item, index) => {
                            return <SubscriptionItemTable key={index} mongoId={item._id} deleteEmail={deleteEmail} email={item.email} date={item.date} />
                        })}
